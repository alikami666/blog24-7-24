...
# 在线图片
![code](https://cdn.jsdelivr.net/gh/alikami1998/markdown_pic/img/code.png)
```
<!-- endtab -->
...
<a href='https://apps.apple.com/cn/app/heart-mate-pro-hrm-utility/id1463348922?ls=1'>
  ...
  <b>心率管家</b>
  {% p red, 专业版 %}
  <img src='https://cdn.jsdelivr.net/gh/alikami1998/cdn-assets/qrcode/heartmate_pro.png'>
</a>
<a href='https://apps.apple.com/cn/app/heart-mate-lite-hrm-utility/id1475747930?ls=1'>
  <i class='fab fa-apple'></i>
  <b>心率管家</b>
  {% p green, 免费版 %}
  <img src='https://cdn.jsdelivr.net/gh/alikami1998/cdn-assets/qrcode/heartmate_lite.png'>
</a>
{% endbtns %}
```
<!-- endtab -->
...
```Markdown
| {% ghcard alikami1998 %} | {% ghcard alikami1998, theme=vue %} |
| -- | -- |
| {% ghcard alikami1998, theme=buefy %} | {% ghcard alikami1998, theme=solarized-light %} |
| {% ghcard alikami1998, theme=onedark %} | {% ghcard alikami1998, theme=solarized-dark %} |
| {% ghcard alikami1998, theme=algolia %} | {% ghcard alikami1998, theme=calm %} |
```
...
```Markdown
{% sitegroup %}
{% site xaoxuu, url=https://xaoxuu.com, screenshot=https://i.loli.net/2020/08/21/VuSwWZ1xAeUHEBC.jpg, avatar=https://cdn.jsdelivr.net/gh/alikami1998/cdn-assets/avatar/avatar.png, description=简约风格 %}
...
<!-- tab 渲染演示 -->
{% sitegroup %}
{% site alikami1998, url=<https://alikami1998.com>, screenshot=<https://i.loli.net/2020/08/21/VuSwWZ1xAeUHEBC.jpg>, avatar=<https://cdn.jsdelivr.net/gh/alikami1998/cdn-assets/avatar/avatar.png>, description=简约风格 %}
{% site inkss, url=<https://inkss.cn>, screenshot=<https://i.loli.net/2020/08/21/Vzbu3i8fXs6Nh5Y.jpg>, avatar=<https://cdn.jsdelivr.net/gh/inkss/common@master/static/web/avatar.jpg>, description=这是一段关于这个网站的描述文字 %}
{% site MHuiG, url=<https://blog.mhuig.top>, screenshot=<https://i.loli.net/2020/08/22/d24zpPlhLYWX6D1.png>, avatar=<https://cdn.jsdelivr.net/gh/MHuiG/imgbed@master/data/p.png>, description=这是一段关于这个网站的描述文字 %}
{% site Colsrch, url=<https://colsrch.top>, screenshot=<https://i.loli.net/2020/08/22/dFRWXm52OVu8qfK.png>, avatar=<https://cdn.jsdelivr.net/gh/Colsrch/images/Colsrch/avatar.jpg>, description=这是一段关于这个网站的描述文字 %}
{% site Linhk1606, url=<https://linhk1606.github.io>, screenshot=<https://i.loli.net/2020/08/21/3PmGLCKicnfow1x.png>, avatar=<https://i.loli.net/2020/02/09/PN7I5RJfFtA93r2.png>, description=这是一段关于这个网站的描述文字 %}
